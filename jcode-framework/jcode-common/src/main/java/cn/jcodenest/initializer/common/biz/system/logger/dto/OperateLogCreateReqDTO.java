package cn.jcodenest.initializer.common.biz.system.logger.dto;
...
public class OperateLogCreateReqDTO {
    ...
    @Schema(description = "操作内容", requiredMode = Schema.RequiredMode.REQUIRED, example = "修改编号为 1 的用户信息, 将性别从男改成女, 将姓名从芋道改成源码")
