...
public class JCodeWebSecurityConfigurerAdapter {
    ...
    /**
     * 由于 Spring Security 创建 AuthenticationManager 对象时没声明 @Bean 注解, 导致无法被注入
     * 通过覆写父类的该方法, 添加 @Bean 注解解决该问题
     */
    @Bean
    ...
    protected SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        // 登录、登录暂时不使用 Spring Security 的拓展点
        // 主要考虑一方面拓展多用户、多种登录方式相对复杂, 一方面学习成本较高

        // 获取 @PermitAll 带来的 URL 列表, 免登录
        ...
        httpSecurity
                ...
                .authorizeHttpRequests(c -> c
                        ...
                        // 1.3 基于 jcode.security.permit-all-urls 无需认证
